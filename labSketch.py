...
hist_fullRGBR =0
hist_fullHSVR =0
mypath='/Users/marie-pierrepoilve/Dropbox/Travail/Travail S13.2015/Visord/code/BaseImageUCD/Pratheepan_Dataset/FacePhoto/' 
toTest='0520962400'
ppeau=0
totalp=0
percentPeau=0
...
def classify(imgName):
    ...
    for x in range(0, imgHeight):
        for y in range(0,imgWidth):
            ...
            histopeau=hist_fullLABF[A,B]
            histononpeau=hist_fullLABR[A,B]
